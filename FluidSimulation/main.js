...
// Skin the whole HUD with the Web437 bitmap font while ASCII mode is on (CSS: body.ascii-font .hud).
function applyAsciiHudFont(on) { document.body.classList.toggle('ascii-font', on); }
